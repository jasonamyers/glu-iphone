 ...
 * Copyright (c) 2009-2011 by Glu, Inc. All Rights Reserved.
...
//@interface GluObject : NSObject
//@end

@interface GluObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GluObject class]])
		{
			for (NSString *key in [[(GluObject*)o modules] allKeys])
			{
