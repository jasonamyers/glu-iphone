...
// in simulator we redefine to format for Glu Developer console
...
{\
	NSString * exceptionName = [@"org.glu." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.glu";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGluNativeItemNone = -1, 
	UIGluNativeItemSpinner = -2,
	UIGluNativeItemProgressBar = -3,
	
	UIGluNativeItemSlider = -4,
	UIGluNativeItemSwitch = -5,
	UIGluNativeItemMultiButton = -6,
	UIGluNativeItemSegmented = -7,
	
	UIGluNativeItemTextView = -8,
	UIGluNativeItemTextField = -9,
	UIGluNativeItemSearchBar = -10,
	
	UIGluNativeItemPicker = -11,
	UIGluNativeItemDatePicker = -12,
	
	UIGluNativeItemInfoLight = -13,
	UIGluNativeItemInfoDark = -14,
	
	UIGluNativeItemDisclosure = -15,
	
	UIGluNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Glu instances of
