...
static NSString * const kGluJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_gluInjection
{
	...
	[html appendString:kGluJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Glu bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _gluInjection]];
